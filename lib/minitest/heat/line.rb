...
module Minitest
  module Heat
    # Represents a line of code from a backtrace to provide more convenient access to information
    #   about the line for displaying in test results
    class Line
      ...
      # A safe interface to getting a string representing the filename portion of the file
      #
